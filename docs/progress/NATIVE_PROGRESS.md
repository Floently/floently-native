...
- M36 started fastest-path cross-cutting parity: agents reassigned by localization, runtime/audio, navigation/payment, backend/material, and theme/design/QA instead of isolated features.
